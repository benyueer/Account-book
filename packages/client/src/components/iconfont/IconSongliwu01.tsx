...
const IconSongliwu01: FunctionComponent<Props> = ({ size, color, style: _style, ...rest }) => {
  const style = _style ? { ...DEFAULT_STYLE, ..._style } : DEFAULT_STYLE;

  return (
    <svg viewBox="0 0 1024 1024" width={size + 'px'} height={size + 'px'} style={style} {...rest}>
      <path
        d="M166.6 606m-26.6 0a26.6 26.6 0 1 0 53.2 0 26.6 26.6 0 1 0-53.2 0Z"
      ...
      <path
        ...
        fill={getIconColor(color, 1, '#FFCD43')}
      />
      <path
...
IconSongliwu01.defaultProps = {
  size: 18,
};

export default IconSongliwu01;
