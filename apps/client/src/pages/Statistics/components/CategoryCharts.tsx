...
interface Props {
  data: StatisticsData['categories']
}
...
export const CategoryCharts = ({ data }: Props) => {
  ...
  return (
    <Card title="分类占比" className="rounded-2xl border-none shadow-sm mb-6">
      <div className="mb-4">
        <Segmented
          options={[
        ...
        {filteredData.length > 0 ? (
          <>
            ...
            <div className="absolute inset-0 flex flex-col items-center justify-center pointer-events-none">
                <span className="text-xs text-slate-400">{type === 'expense' ? '总支出' : '总收入'}</span>
